...
foreach ($file in $files) {
    ...
    $idx = $content.IndexOf('<LinearLayout')
    $lastIdx = $content.LastIndexOf('<LinearLayout')
    
    # We want to replace the LAST <LinearLayout ... android:id="@+id/btn_next_view" ...
    # Instead, we just regex replace the specific block.
